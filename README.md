# 🌐 Portfólio Pessoal — Joaquim Guellis

Página web de portfólio desenvolvida do zero com HTML e CSS puro, hospedada via GitHub Pages.
...
- GitHub: [@joaquimGuellis](https://github.com/joaquimGuellis)
- E-mail: joaquimguellisdev@gmail.com